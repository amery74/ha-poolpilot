...
- Ajout de l’entité `RedOx cible` réglable de 500 à 900 mV (700 mV par défaut).
- Les alertes, vigilances, recommandations et le risque d’algues utilisent désormais la cible ORP en mode RedOx.
- Conservation de la consigne chlore pour le mode « Chlore libre » et compatibilité avec les configurations existantes.
