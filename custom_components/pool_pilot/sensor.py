...
SENSORS = (
   ...
   PoolPilotSensorDescription(key="auto_schedule_next_start", translation_key="auto_schedule_next_start", icon="mdi:clock-start", value_fn=lambda d: d.auto_schedule_next_start.isoformat() if d.auto_schedule_next_start else None, attrs_fn=lambda d: {"status": d.auto_schedule_status, "windows": d.auto_schedule_windows, "target_hours": d.auto_schedule_target_hours, "done_hours": d.auto_schedule_done_hours, "end_limit": d.auto_schedule_end_limit, "detail": d.auto_schedule_detail}),
