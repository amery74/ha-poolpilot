...
NUMBERS = (
    ...
    PoolPilotNumberDescription(key="target_orp", translation_key="target_orp", config_key=CONF_TARGET_ORP, default_value=DEFAULT_TARGET_ORP, native_min_value=100, native_max_value=1000, native_step=10, native_unit_of_measurement="mV", mode=NumberMode.SLIDER, icon="mdi:chart-bell-curve"),
    ...
    PoolPilotNumberDescription(key="filtration_center_hour", translation_key="filtration_center_hour", config_key=CONF_FILTRATION_CENTER_HOUR, default_value=DEFAULT_FILTRATION_CENTER_HOUR, native_min_value=0, native_max_value=23.5, native_step=0.5, native_unit_of_measurement="h", mode=NumberMode.BOX, icon="mdi:clock-time-twelve-outline"),
