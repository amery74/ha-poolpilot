...
CONF_COVER_CONFIRM_OPEN: Final = "cover_confirm_open"
CONF_COVER_CONFIRM_CLOSE: Final = "cover_confirm_close"
...
PLATFORMS = ["sensor", "number", "button", "select", "switch", "time"]
